...
export default function PlayBookTab({ book }: PlayBookTabProps) {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 max-md:pb-24">
      ...
      <div className="max-md:fixed max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:z-20 max-md:border-t max-md:border-[rgba(62,39,51,0.12)] max-md:bg-book-background max-md:px-4 max-md:pt-4 max-md:pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
